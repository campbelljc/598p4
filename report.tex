...
% 1 Mohamed, Ehab I., et al. "Predicting Type 2 diabetes using an electronic nose-based artificial neural network analysis." Diabetes, nutrition & metabolism 15.4 (2002): 215-221.
% 2 Pappada, Scott M., et al. "Neural network-based real-time prediction of glucose in patients with insulin-dependent diabetes." Diabetes technology & therapeutics 13.2 (2011): 135-141.
% 3 Zainuddin, Zarita, Ong Pauline, and Cemal Ardil. "A neural network approach in predicting the blood glucose level for diabetic patients." Int. J. Comput. Intell 5.1 (2009): 72-79.
% 4 Kelarev, A. V., et al. "Empirical study of decision trees and ensemble classifiers for monitoring of diabetes patients in pervasive healthcare."Network-Based Information Systems (NBiS), 2012 15th International Conference on. IEEE, 2012.
% 5 Tama, Bayu Adhi, F. S. Rodiyatul, and Hermansyah Hermansyah. "An Early Detection Method of Type-2 Diabetes Mellitus in Public Hospital."TELKOMNIKA (Telecommunication Computing Electronics and Control) 9.2 (2013): 287-294.
